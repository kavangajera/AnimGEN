...
#         # return send_from_directory('videos','probability.mp4')
...
# Define directories using environment variable
MEDIA_DIR = os.getenv('MEDIA_DIR', '/app/workspace/media')
MANIM_DIR = os.path.join(os.getcwd(), 'manim_files')
...
def run_manim():
    try:
        ...
        # Updated command with 240p resolution
        cmd = ["manim", "-pql", "--resolution", "426,240", "scene.py", "HelloWorldScene"]
...
def get_latest_video():
    try:
        # Look for the latest mp4 file in the media directory
        ...
        print("[ERROR] Failed to find video file:", str(e))
        return None
